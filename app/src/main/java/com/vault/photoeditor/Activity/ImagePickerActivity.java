...
//        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.colorPrimary));
        ...
        System.out.println("In Imagepicker activity ratio is "+ASPECT_RATIO_X + ASPECT_RATIO_Y);

        if (setBitmapMaxWidthHeight)
            options.withMaxResultSize(bitmapMaxWidth, bitmapMaxHeight);
        System.out.println("In Imagepicker activity size is "+ ASPECT_RATIO_X+ ASPECT_RATIO_Y + bitmapMaxWidth + "and" +bitmapMaxHeight);
