package com.vault.photoeditor.tools;
...
//        mToolList.add(new ToolModel("Eraser", R.drawable.ic_eraser, ToolType.ERASER));
        mToolList.add(new ToolModel("Noir", R.drawable.ic_photo_filter, ToolType.FILTER));
//        mToolList.add(new ToolModel("Emoji", R.drawable.ic_insert_emoticon, ToolType.EMOJI));
        mToolList.add(new ToolModel("Symbol", R.drawable.ic_symbol, ToolType.STICKER));
        mToolList.add(new ToolModel("Background", R.drawable.ic_sticker, ToolType.BACKGROUND));
    }
