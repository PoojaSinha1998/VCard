package com.burhanrashid52.photoeditor.photoViewLib;
...
import static com.burhanrashid52.photoeditor.photoViewLib.PhotoFilter.NONE;
...
class ImageFilterView extends GLSurfaceView implements GLSurfaceView.Renderer {
 ...
 /*   public void setOpacity(@IntRange(from = 0, to = 100) int opacity) {
        if (mCurrentEffect != null) {
            ...
            mCurrentEffect.setOpacity(opacity);
        }
    }*/
